...
\def\presentationtitle{The Augmented Agronomist Pipeline and Time Series Forecasting}

\title{\presentationtitle}
\author[G. Onoufriou]{{George Onoufriou, Marc Hanheide, Georgios Leontidis} \\*
    {\footnotesize\faEnvelope \, \texttt{gonoufriou@lincoln.ac.uk}}
}
\institute{\faInstitution \, University of Lincoln, UK}
...
\begin{frame}{The Problem}
    ...
    \begin{textblock*}{9cm}(3cm,2cm) % {block width} (coords)
    % \includegraphics[width=\linewidth]{imgs/lindsey.jpg}
    \includegraphics[width=\linewidth]{imgs/riseholme}
    \end{textblock*}

    \begin{textblock*}{5cm}(1cm,1.5cm)
    \begin{block}{Outline} % {block width} (coords)
      \begin{itemize}
        \item Lack of specialists (Optimising human time)
        \item Large variance in accuracy (Consistency)
        \item Low human accuracy (0.25 loss)
      \end{itemize}
    \end{block}
    \end{textblock*}
...
\begin{frame}{The Solution}
    ...
    \begin{block}{Nemesyst} % {block width} (coords)
    The solution
    \end{block}
    \end{textblock*}
    ...
    % \includegraphics[width=\linewidth]{imgs/lindsey.jpg}
    \includegraphics[width=\linewidth]{imgs/pipeline}
    \end{textblock*}
...
\frametitle{References}
    ...
    \bibliography{bibliography.bib,conference.bib}%must have no space after ,
